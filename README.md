...
| model_4 | ZG-102Z | [ZG-102ZA](https://www.zigbee2mqtt.io/devices/ZG-102ZA.html) | HOBEIAN             | [HOBEIAN](https://www.zigbee2mqtt.io/supported-devices/#v=HOBEIAN) | BIN file | [:camera:](doc/images/device_ZG-102ZA.jpg) |
...
- 1.0.03
	...
	- Добавлен повтор команд `OnOff`, если ответ не получен в течение 1 секунды.
