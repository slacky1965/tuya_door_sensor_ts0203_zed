...
zcl_iasZoneAttr_t g_zcl_iasZoneAttrs =
{
    ...
    .zoneType       = ZONE_TYPE_DOOR_WINDOW_HANDLE,
...
#endif
#ifdef ZCL_ON_OFF_SWITCH_CFG
    {ZCL_CLUSTER_GEN_ON_OFF_SWITCH_CONFIG,   MANUFACTURER_CODE_NONE, ZCL_ON_OFF_SWITCH_CFG_ATTR1_NUM, onoff_switch_cfg_attrTbl,  zcl_onOffSwitchCfg_register,            NULL              },
#endif
#ifdef ZCL_IAS_ZONE
    {ZCL_CLUSTER_SS_IAS_ZONE,   MANUFACTURER_CODE_NONE, ZCL_IASZONE_ATTR_NUM,   iasZone_attrTbl,    zcl_iasZone_register,   door_iasZoneCb},
#endif
};
