...
//#ifdef ZCL_IAS_ZONE
/*********************************************************************
 * @fn      door_zclIasZoneEnrollRspCmdHandler
 *
...
/*********************************************************************
 * @fn      door_zclIasZoneInitNormalOperationModeCmdHandler
 *
...
/*********************************************************************
 * @fn      door_zclIasZoneInitTestModeCmdHandler
 *
    ...
    if(pAddrInfo->dirCluster == ZCL_FRAME_CLIENT_SERVER_DIR){
        switch(cmdId){
            case ZCL_CMD_ZONE_ENROLL_RSP:
                door_zclIasZoneEnrollRspCmdHandler((zoneEnrollRsp_t *)cmdPayload, pAddrInfo->dstEp);
                break;
            case ZCL_CMD_INIT_NORMAL_OPERATION_MODE:
                door_zclIasZoneInitNormalOperationModeCmdHandler();
                break;
            case ZCL_CMD_INIT_TEST_MODE:
                door_zclIasZoneInitTestModeCmdHandler((zoneInitTestMode_t *)cmdPayload);
                break;
            default:
                break;
        }
